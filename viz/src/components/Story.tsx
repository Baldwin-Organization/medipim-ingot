...
import RecordLifecycle from "./chapters/RecordLifecycle";
import TwoClocks from "./chapters/TwoClocks";
...
const CHAPTERS: Chapter[] = [
  ...
  {
    id: "record",
    title: "The record keeps changing",
    stepIds: story.record.steps.map((s) => s.id),
    render: (step) => <RecordLifecycle scene={story.record} step={step} />,
  },
  {
    id: "machine",
  ...
  },
  {
    id: "clocks",
    title: "Two clocks",
    stepIds: story.clocks.steps.map((s) => s.id),
    render: (step) => <TwoClocks scene={story.clocks} step={step} />,
  },
  {
    id: "guard",
    title: "The guard",
